...
/**
 * Modified class java.util.StringTokenizer
...
public class SimpleTokenizer implements Enumeration<String> {
     ...
     */
    public SimpleTokenizer(String str, String delim, boolean returnDelims) {
        currentPosition = 0;
        newPosition = -1;
        delimsChanged = false;
        this.str = str;
     ...
     * @exception NullPointerException if str is <CODE>null</CODE>
     */
    public SimpleTokenizer(String str, String delim) {
